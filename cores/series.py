...
class SeriesNAnime():
	...
	def series_name(self, sn):
		...
		print('Many series with similar names. Select one you need.')
		for no, x in enumerate(data): print(no, x['seriesName'], x['firstAired'])
...
def main():
	a = SeriesNAnime(name = 'silicon valley', season = 4)
